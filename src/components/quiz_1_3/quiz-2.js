...
answer.set(
  2,
  "Попробуйте начать бегать или освоить велосипед. Регулярная активность снижает уровень стресса и помогает бороться с тревогой.  Хотите уточнить результат? Вы можете записаться на консультацию. Хотите больше знать о тренировках для ментального здоровья? Вот несколько интересных статей об этом."
); //(010) = 2
answer.set(
  4,
  "Посмотрите в сторону персональных тренировок по танцам, кроссфиту или другим активным направлениям. И разнообразие, и антистресс. Хотите уточнить результат? Вы можете записаться на консультацию. Хотите больше знать о тренировках для ментального здоровья? Вот несколько интересных статей об этом."
); //(100) = 4
answer.set(
  0,
  "Возможно, вам понравится хайкинг, сноуборд или велосипед. Сезонные увлечения не приедаются и могут даже стать приятной традицией. Главное — выбирать активные направления.    Хотите уточнить результат? Вы можете записаться на консультацию. Хотите больше знать о тренировках для ментального здоровья? Вот несколько интересных статей об этом."
); //(000) = 0
